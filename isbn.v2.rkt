...
(define digits (map string (string->list "0123456789")))
...
(define (isbn-word? str)
  (for/and ([c (string->list str)]) (isbn-letter? (string c))))
...
(define (isbn-letter? str) (cons? (member str isbn-letters)))
...
;; String -> [List-of String]
;; splits str into words trimming repeated spaces
...
(define (digit? v) (cons? (member v digits)))
